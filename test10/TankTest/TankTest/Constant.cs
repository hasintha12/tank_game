...
namespace TankTest
{
    ...
    public class Constant
    {
        ...
        public const string GRIDTYPE_NORMAL = "NORMAL";
        public const string GRIDTYPE_BRICK = "BRICK";
        public const string GRIDTYPE_STONE = "STONE";
        public const string GRIDTYPE_WATER = "WATER";
        public const string GRIDTYPE_LIFEPACK = "LIFEPACK";
        public const string GRIDTYPE_COIN = "COIN";
        public const int COINLIFE_REFRESHDELAY = 10;
        #endregion
